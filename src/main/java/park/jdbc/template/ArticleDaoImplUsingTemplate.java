...
import park.jdbc.rqw.Article;
import park.jdbc.rqw.ArticleDao;
...
public class ArticleDaoImplUsingTemplate implements ArticleDao {
	 ...
	 * 목록 가져오는 sql
	 */
	static final String LIST_ARTICLES = "SELECT articleId,content,userId, title, name, cdate FROM article LIMIT 20";
	/**
	 * 글 1개 가져오는 sql
	 */
	...
	public ArticleDaoImplUsingTemplate() {
		dataSource = new MariaDbDataSource(
				"jdbc:mariadb://localhost:3306/JWdb?user=USERNAME&password=5412");
